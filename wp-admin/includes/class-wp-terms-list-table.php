...
class WP_Terms_List_Table extends WP_List_Table {
	...
	public function __construct( $args = array() ) {
		global $filter_post_type, $taxonomy, $action, $tax;
		...
		$filter_post_type = $this->screen->post_type;
		...
		if (empty( $filter_post_type ) || !in_array( $filter_post_type, get_post_types( array('show_ui' => true ) ) ) )
