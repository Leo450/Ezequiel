...
if ('post' != $filter_post_type ) {
	$parent_file = ('attachment' == $filter_post_type ) ? 'upload.php' : "edit.php?post_type=$filter_post_type";
	$submenu_file = "edit-tags.php?taxonomy=$taxonomy&amp;post_type=$filter_post_type";
...
case 'edit':
	...
	wp_redirect( esc_url_raw( get_edit_term_link( $term_id, $taxonomy, $filter_post_type ) ) );
	exit;
...
<input type="hidden" name="post_type" value="<?php echo esc_attr($filter_post_type); ?>" />
